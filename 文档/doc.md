...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Windows 用户" key="qqTqPGVLsI"><RenderMd content={`1. 进入 \`scripts/init_dev_env\` 目录。
...
<Tabs.TabPane title="macOS 用户" key="IkeTujgeMb"><RenderMd content={`1. 打开终端，进入 \`scripts/init_dev_env\` 目录。
2. 运行构建脚本：
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="BcTPzMUWZL"><RenderMd content={`\`\`\`Python
import os
import time
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="F5QjcmrFuT"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="PNJSLTkM1H"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="Np9V0Iqrtn"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="l7E3Fxvqek"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="xUKTHeMRug"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="aJ8ibFg6Aw"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="OXg9rN9pFd"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="NKJZg5dc1I"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="wAwbuCQHUJ"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="aFdzXTKOUD"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="KT8WNpSkjD"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="BSNtm1s7V0"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用预置虚拟人像](/docs/82379/2291680#2bf01416)示例生成的视频。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="diVfjfZ5D2"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
2. 对 seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="thCxbF1weu"><RenderMd content={`1. 首次生视频，并获取视频 URL。此处直接用[使用虚拟人像](/docs/82379/2277377#2bf01416)的例子。
2. 对 seedance 2.0 生成的视频进行再次编辑。视频原始 URL 的有效期仅 24 小时，本示例将原始视频转存至 TOS 使用。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="NmNvnfp1dD"><RenderMd content={`\`\`\`Python
import os
import time
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="XdvbQxzIKc"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="nFpHcmqdLI"><RenderMd content={`\`\`\`Go
package main
